...
Till Tech Test | Work In Progress. Order can be entered, total is calculated (including tax and discounts), payment can be entered and a receipt is generated |  JavaScript/JQuery   - Tested with Jasmine | No Time Constraint | [GitHub](https://github.com/DanielleInkster/tech_test_3)
